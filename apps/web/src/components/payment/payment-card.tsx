  ...
  return (
    <Card className="w-full max-w-lg">
      ...
      <CardContent className="space-y-6">
        {/* QR Code */}
        <div className="flex justify-center p-6 bg-white border-4 border-border shadow-[4px_4px_0px_0px_var(--shadow-color)] hover:shadow-[6px_6px_0px_0px_var(--shadow-color)] transition-all">
          <QRCodeSVG
